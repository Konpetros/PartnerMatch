    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 animate-fade-in">
      ...
      <div className="text-center space-y-4 mb-12">
        ...
        <p className="text-base text-slate-500 font-medium max-w-2xl mx-auto">
          Please read these terms carefully before using PartnerMatch. By creating an account or submitting a listing, you agree to these terms.
        </p>
      ...
      <div className="space-y-4">
        ...
        <Section title="1. About PartnerMatch">
          <p>
            PartnerMatch is a free online partner search directory designed exclusively for organisations participating in the Erasmus+ programme across Europe. The platform is operated by <strong>PartnerMatch</strong>, based in Corfu, Greece.
          </p>
          <p>
            PartnerMatch is an independent platform and is not affiliated with, endorsed by, or connected to the European Commission, any National Agency, or any other official Erasmus+ body.
          </p>
        </Section>

        <Section title="2. Eligibility">
          <p>By registering on PartnerMatch, you confirm that:</p>
        ...
        <Section title="3. User Accounts">
          <p>
            To submit listings or create an organisation profile on PartnerMatch, you must create an account using a valid email address or Google account. You are responsible for:
          </p>
          <ul className="list-disc pl-5 space-y-2">
            <li>Maintaining the confidentiality of your account credentials.</li>
            <li>All activity that occurs under your account.</li>
            <li>Notifying us immediately at <a href="mailto:support@partnermatch.eu" className="text-brand-primary font-semibold hover:underline">support@partnermatch.eu</a> if you suspect any unauthorised use of your account.</li>
          </ul>
          <p>
            PartnerMatch reserves the right to suspend or terminate accounts that violate these terms or that have been inactive for an extended period.
          </p>
        </Section>

        <Section title="4. Organisation Profiles">
          <p>
            When you create an organisation profile, the information you provide will be displayed publicly on PartnerMatch and will be visible to all visitors, including non-registered users. You are responsible for ensuring that:
          </p>
          <ul className="list-disc pl-5 space-y-2">
        ...
        <Section title="5. Partner Search Listings">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>Your listing will be reviewed by PartnerMatch administrators before being published. We reserve the right to reject any listing that does not meet our standards or that violates these terms.</li>
        ...
        <Section title="6. Ownership of Content">
          <p>
            You retain full ownership of all content you submit to PartnerMatch, including your organisation profile information, listing descriptions, and uploaded images.
          </p>
          <p>
            By submitting content to PartnerMatch, you grant PartnerMatch a non-exclusive, royalty-free, worldwide licence to display, reproduce, and distribute your content on the platform for the purpose of facilitating Erasmus+ partner search. This licence ends when you delete your content or your account.
          </p>
          <p>
        ...
        <Section title="7. Prohibited Conduct">
          <p>When using PartnerMatch, you agree not to:</p>
          <ul className="list-disc pl-5 space-y-2">
        ...
        <Section title="8. Moderation and Content Removal">
          <p>
            PartnerMatch operates a moderation system to ensure the quality and integrity of content on the platform:
          </p>
          <ul className="list-disc pl-5 space-y-2">
            <li><strong>Admin review</strong> — all partner search listings are reviewed by PartnerMatch administrators before being published. We reserve the right to reject or remove any listing that violates these terms or does not meet our quality standards.</li>
            ...
            <li><strong>User reporting</strong> — users may report listings or profiles they believe violate these terms by contacting us at <a href="mailto:support@partnermatch.eu" className="text-brand-primary font-semibold hover:underline">support@partnermatch.eu</a>.</li>
          </ul>
          <p>
            PartnerMatch reserves the right to remove any content, suspend any account, or restrict access to the platform at its sole discretion without prior notice.
          </p>
        </Section>

        <Section title="9. Disclaimer of Warranties">
          <p>
            PartnerMatch is provided on an "as is" and "as available" basis. While we strive to maintain a high-quality, reliable platform, we make no warranties or representations of any kind, express or implied, including but not limited to:
          </p>
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>That any partnership contacts made through PartnerMatch will result in successful Erasmus+ applications or projects.</li>
          </ul>
          <p>
            PartnerMatch is a directory tool only. We are not responsible for the outcome of any partnership negotiations, project applications, or collaborations that arise from use of the platform.
          </p>
        </Section>

        <Section title="10. Limitation of Liability">
          <p>
            To the fullest extent permitted by applicable law, PartnerMatch shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of, or inability to use, the platform, including but not limited to:
          </p>
          <ul className="list-disc pl-5 space-y-2">
        ...
        <Section title="11. Third-Party Links and Resources">
          <p>
            PartnerMatch may contain links to third-party websites and resources, including official Erasmus+ resources and organisation websites. These links are provided for convenience only. PartnerMatch does not endorse or take responsibility for the content, privacy practices, or availability of any third-party websites.
          </p>
        </Section>

        <Section title="12. Changes to These Terms">
          <p>
            PartnerMatch reserves the right to update these Terms & Conditions at any time. When we make significant changes, we will update the "Last updated" date at the top of this page. Your continued use of the platform after any changes constitutes your acceptance of the updated terms.
          </p>
          <p>
            If you do not agree with any changes to these terms, you should stop using PartnerMatch and may request deletion of your account by contacting us.
          </p>
        </Section>

        <Section title="13. Governing Law">
          <p>
            These Terms & Conditions are governed by and construed in accordance with the laws of Greece. Any disputes arising from or relating to these terms or your use of PartnerMatch shall be subject to the exclusive jurisdiction of the courts of Greece.
          </p>
        </Section>
        ...
        <Section title="14. Contact Us">
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>Email:</strong> <a href="mailto:support@partnermatch.eu" className="text-brand-primary font-semibold hover:underline">support@partnermatch.eu</a></li>
            <li><strong>Operator:</strong> PartnerMatch</li>
      ...
      <div className="mt-12 bg-blue-50 border border-blue-100 rounded-2xl p-8 text-center space-y-4">
        ...
        <p className="text-sm text-slate-500 max-w-lg mx-auto">
          If you have any questions about these Terms & Conditions or how PartnerMatch operates, please get in touch.
        </p>
        <a
